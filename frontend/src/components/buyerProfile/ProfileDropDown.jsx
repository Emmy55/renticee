...
function ProfileDropDown() {
  ...
  return (
    <div className="z-50 flex flex-col items-center text-xs w-[180px] bg-white pb-5 rounded font-bold relative">
      <div className="">
        <div className="mt-8">
          {/* profile start */}
          <NavLink
          ...
          <NavLink
            to="/transaction"
            className={({ isActive }) =>
              isActive ? activeLink + setIsTrasactionHovered(true) : normalLink
            }
          >
            <div className="flex items-center gap-3 mt-10 cursor-pointer ">
              <svg
