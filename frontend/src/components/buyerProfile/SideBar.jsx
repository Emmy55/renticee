        ...
        <div className="mt-10">
          ...
          <div className="mt-8">
            ...
            <div className="flex items-center gap-3 cursor-pointer">
              ...
              <p className="text-[0.875rem] font-medium text-[#035FCE] font-Roboto lg:text-[1.4375rem]">
                Profile
              </p>
            </div>
            {/* Profile end */}
            {/* Notification end */}
            <div className="flex items-center gap-3 mt-10 hover:scale-105 cursor-pointer hover:fill-[#035FCE] hover:stroke-[#035FCE] hover:text-[#035FCE]">
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
              ...
              {/* <img src={ProfileIcon} alt="" className="fill-black stroke-black" /> */}
              <p className="text-[0.875rem] font-medium text-[#63666D] font-Roboto lg:text-[1.4375rem] hover:text-[#035FCE]">
                Notification
              </p>
            </div>
            {/* Notification end */}
            {/* trnsaction end */}
            <div className="flex items-center gap-3 mt-10 cursor-pointer hover:scale-105 hover:fill-[#035FCE] hover:stroke-[#035FCE] hover:text-[#035FCE]">
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
