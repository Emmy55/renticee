  ...
  return (
    <div>
      <div className="bg-insura-hero-img2 md:bg-insura-hero-img h-[282px] lg:h-[575px] object-center bg-cover bg-no-repeat">
        <h1 className="text-sm text-white text-center pt-[55px] font-Roboto lg:text-[1.4375rem] lg:pt-44">
          Rentice Nigeria House Insurance
        </h1>
        <motion.h1
          className="text-[1.0625rem] text-white text-center pt-[40px] font-Roboto lg:text-5xl"
