      ...
      <div className="min-h-screen">
        ...
        {showAdditionalDiv && (
          <div className="relative top-12 left-5 lg:left-64 lg:ml-5 w-80 lg:top-0 lg:w-80">
            <p className="text-[#035FCE] font-bold">Notification Setting</p>
            <hr className="mt-6 relative right-5" />
            ...
            <div className="mt-7">
              ...
              <Link to="/SaveChanges">
                <input
                  type="submit"
                  className="bg-[#C2C7D0] text-white placeholder-gray-600 mt-2 h-12 w-40 rounded focus:outline-none float-right relative right-10"
                  value="Save changes"
                />
              </Link>
              {/* <br/> */}
        ...
        {showAdditionalDiv1 && (
          <div>
            <div className="relative top-12 left-5 mb-40">
              <p className="text-[#035FCE] font-bold">Property</p>
              ...
              <div className="shadow-lg h-4/6 ml-1 w-80 relative mt-8">
                ...
                <div className="z-50 ml-6 w-96 right-4 text-xs relative -top-7 text-white flex">
                  <p>
                    {" "}
                    <FontAwesomeIcon
                      icon={faLocationDot}
                ...
                <div className="z-50 w-96 pl-2 p-3 pt-6">
